...
public class LayoutPage {
    ...
    private static final String layoutOptionText = "//div[contains(@class,'node_modules-react-multilevel-dropdown-__menu-left')]//li[contains(text(),'%s')]";
    ...
    private static final String LAYOUT_OPTION_TEXT = "//div[contains(@class,'node_modules-react-multilevel-dropdown-__menu-left')]//li[contains(text(),'%s')]";
...
//    private static final String PRESCRIBER_FIELD = "";
    ...
    public void deleteMedicine(String medicine) throws AutomationException {
        try {
            ...
            // Wait for the confirmation popup to disappear
